    ...
    <div className={styles.Userdetail}>
      ...
      <div className={styles.div2}>
       ...
       <div className={styles.text}>
            <TextInput label={"User Details"} placeholder={"Enter your email address"} helperText={" This is a hint text to help user."}/>
            <TextInput label={"User Details"} placeholder={"Enter your email address"} helperText={" This is a hint text to help user."}/>
        </div>
       <div className={styles.text}>
            <TextInput label={"User Details"} placeholder={"Enter your email address"} helperText={" This is a hint text to help user."}/>
      ...
      <div className={styles.text}> <RadioButton /> <p className={styles.t3Req}>Training Name 124134143 | 12 Chapters | 20 Lessons</p></div>
     
      </div>
      <div className={styles.subText}>
        <div className={styles.subText_1}>
            <img src={checkmark } />
            <p>10 lessons completed</p>
        </div>
        <div className={styles.subText_2}>
            <img src={checkmark } />
            <p>10 videos completed</p>
        </div>
        <div className={styles.subText_3}>
            <img src={checkmark } />
            <p>10 quizzs completed</p>
        </div>
      </div>
      </div>
